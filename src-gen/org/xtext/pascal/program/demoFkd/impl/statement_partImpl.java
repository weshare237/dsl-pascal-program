 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.pascal.program.demoFkd.impl.statement_partImpl#getSequence <em>Sequence</em>}</li>
 * </ul>
 *
 * @generated
 */
public class statement_partImpl extends MinimalEObjectImpl.Container implements statement_part
{
  ...
  {
    return DemoFkdPackage.Literals.STATEMENT_PART;
  }
  ...
  public NotificationChain basicSetSequence(statement_sequence newSequence, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DemoFkdPackage.STATEMENT_PART__SEQUENCE, oldSequence, newSequence);
  ...
  public void setSequence(statement_sequence newSequence)
  {
    if (newSequence != sequence)
    {
      ...
      if (sequence != null)
        msgs = ((InternalEObject)sequence).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DemoFkdPackage.STATEMENT_PART__SEQUENCE, null, msgs);
      if (newSequence != null)
        msgs = ((InternalEObject)newSequence).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DemoFkdPackage.STATEMENT_PART__SEQUENCE, null, msgs);
      msgs = basicSetSequence(newSequence, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DemoFkdPackage.STATEMENT_PART__SEQUENCE, newSequence, newSequence));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DemoFkdPackage.STATEMENT_PART__SEQUENCE:
